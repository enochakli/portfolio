...
| Task analysis | Experimental flow |
|---|---|
| ![Task analysis](../assets/audio-social/task-analysis.png) | ![Experiment flow](../assets/audio-social/experiment-flow.png) |
...
|---|---|
| ![Elapsed time results](../assets/audio-social/time-results.png) | ![Post-questionnaire results](../assets/audio-social/postq-results.png) |
